...
<div class="col-md-6">
    <form action="" id="user-form">
        ...
        <div class="form-group">
            <label for="conf_password" class="control-label">Confiramtion Password</label>
            <input type="password" name="conf_password" id="conf_password" class="form-control form-control-sm rounded-0" value="">
        </div>
        <div class="form-group">
